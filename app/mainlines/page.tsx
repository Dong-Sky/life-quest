...
export default function MainlinesPage() {
  ...
  return <div className="mx-auto max-w-5xl px-5 py-8 sm:px-8">
    <header className="border-b border-[var(--line)] pb-6"><p className="text-sm text-[var(--muted)]">主线</p><h1 className="mt-1 text-2xl font-semibold tracking-tight">先定义长期方向，再安排下一步。</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--muted)]">主线是持续数月的长期方向，不等同于一张待办清单。你可以先创建任务或副本，之后再回来关联到主线。</p></header>
